...
[![Portfolio](https://img.shields.io/badge/Portfolio-nithin0x.space-1D9E75?style=for-the-badge&logo=firefox&logoColor=white)](https://portfolio.nithin0x.space/)
...
[![Status](https://img.shields.io/badge/Status-Open_to_Work-brightgreen?style=for-the-badge&logo=statuspage&logoColor=white)](https://portfolio.nithin0x.space/#contact)

```
$ whoami --verbose
Nithin Kumar M — Cybersecurity Analyst @ TiQHUB, LLC · 3+ years
Focus:   Cloud Security (AWS/Azure/M365) · Active Directory · Web/API · AI/LLM Security
Method:  Simulate the attack path end-to-end, then validate the fix actually holds
Status:  Open to Full-time · Contract · Remote  |  Tamil Nadu, India
```

I'm a cybersecurity analyst who spends half my time thinking like an attacker and the other half making sure that thinking gets shipped as a fix. I run threat modeling, vulnerability assessment, and hardening across AWS/Azure/M365 for my day job, and I break Active Directory, web apps, and LLM-backed apps in my home lab so I know what "secure" actually has to survive.

| 🛡️ 3+ Years | 🎓 6 Certifications | ☁️ 3 Cloud Platforms | 🧪 24/7 Home Lab |
| ----------- | ------------------- | --------------------- | ----------------- |

## 🧠 What I Do

- 🌐 **Web Application & API Security** — manual exploitation, auth/logic flaws, Burp/Caido-driven testing
- 🏢 **Active Directory & Internal Network** — full attack-path simulation with BloodHound, Certipy, Impacket, NetExec
- ☁️ **Cloud Security** — privilege-escalation paths and misconfig hunting across AWS, Azure, and Microsoft 365
- 🤖 **AI / LLM Attack Surface** — threat modeling for LLM-backed apps and agentic workflows
- ⚙️ **Automation** — Python, PowerShell, and Bash tooling so hardening and audits are repeatable, not one-off

📝 Full attack paths, cloud abuse write-ups, and remediation notes live at **[nithin0x.space](https://nithin0x.space)**
...
| ![AZ-900](https://img.shields.io/badge/AZ--900-Azure_Fundamentals-0078D4?style=flat-square&logo=microsoftazure&logoColor=white) | Microsoft | 2026 |
...
| Category | Tools |
| -------- | ----- |
| **Offensive Security** | BloodHound · Certipy · Impacket · NetExec · Sliver C2 · Metasploit · Caido · Nmap · FFUF |
| **Cloud & Identity** | Microsoft Entra ID · Intune · Zero Trust · Conditional Access · Prowler · IAM |
...
[![GitHub Stats](https://github-readme-stats.vercel.app/api?username=nithin0x&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=1D9E75&icon_color=1D9E75&text_color=c9d1d9)](https://github.com/nithin0x)
[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=nithin0x&layout=compact&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=1D9E75&text_color=c9d1d9&langs_count=6)](https://github.com/nithin0x)

[![GitHub Streak](https://streak-stats.demolab.com/?user=nithin0x&theme=tokyonight&hide_border=true&background=0D1117&ring=1D9E75&fire=1D9E75&currStreakLabel=1D9E75)](https://github.com/nithin0x)
...
$ check_availability
status: ✓ available
roles:  Penetration Testing · Cloud Security · Security Engineering
type:   Full-time · Contract · Remote
where:  Tamil Nadu, India · Remote OK
```

[![LinkedIn](https://img.shields.io/badge/LinkedIn-cybernithin-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/cybernithin)
[![Portfolio](https://img.shields.io/badge/Portfolio-View_Resume-1D9E75?style=for-the-badge&logo=firefox&logoColor=white)](https://portfolio.nithin0x.space/)
[![Blog](https://img.shields.io/badge/Blog-Read_Writeups-1D9E75?style=for-the-badge&logo=hashnode&logoColor=white)](https://nithin0x.space)

---

© 2026 Nithin Kumar M · [![Profile Views](https://komarev.com/ghpvc/?username=nithin0x&label=Profile+Views&color=1D9E75&style=flat)](https://github.com/nithin0x)
